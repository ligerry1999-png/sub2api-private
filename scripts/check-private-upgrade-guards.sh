...
assert_contains "$database_rehearsal" "231_add_usage_log_requested_reasoning_effort.sql"
assert_contains "$database_rehearsal" "232_add_usage_log_upstream_request_id.sql"
assert_contains "$database_rehearsal" "233_group_free_openai_fast.sql"
assert_contains "$database_rehearsal" "234_group_codex_models_manifest_config.sql"
