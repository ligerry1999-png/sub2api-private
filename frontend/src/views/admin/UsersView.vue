            ...
            <div v-if="visibleFilters.has('role')" class="w-full sm:w-32">
              <Select
                ...
                :options="[
                  ...
                  { value: 'account_manager', label: t('admin.users.roles.account_manager') },
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-role="{ value }">
            <span :class="['badge', value === 'admin' ? 'badge-purple' : value === 'account_manager' ? 'badge-primary' : 'badge-gray']">
