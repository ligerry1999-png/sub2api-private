...
func (s *OpenAIGatewayService) forwardOpenAIImagesViaWorker(
	...
	responseBody, err := buildOpenAIImagesAPIResponseWithDelivery(results, createdAt, nil, firstMeta, parsed.ResponseFormat, s.openAIImagesResultDeliveryOptions(c, parsed))
	if err != nil {
		return nil, err
	}
