...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	wire.Build(
		...
		// Application struct
		wire.Struct(new(Application), "Server", "PromptAudit", "OpenAIGateway", "PluginManager", "Cleanup"),
	)
	return nil, nil
}
...
func provideCleanup(
	...
	imageLogCleanup *service.ImageLogCleanupService,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			{"OpenAIImageJobDispatcher", func() error {
				if openAIGatewayHandler != nil {
					openAIGatewayHandler.StopImageJobDispatcher()
				}
				return nil
			}},
			...
			{"ImageLogCleanupService", func() error {
				if imageLogCleanup != nil {
					imageLogCleanup.Stop()
				}
				return nil
			}},
